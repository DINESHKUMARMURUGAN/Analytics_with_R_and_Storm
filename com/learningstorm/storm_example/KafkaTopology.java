...
public class KafkaTopology {
	public static void main(String[] args) throws
	  AlreadyAliveException, InvalidTopologyException {
	    ...
	    SpoutConfig kafkaConfig = new SpoutConfig(zkHosts, "testKafkaPartition13", "/testKafkaPartition10", "site1");
	    ...
	    builder.setBolt("LearningBolt2", new LearningBolt2(), 4).shuffleGrouping("KafkaSpout");
	    ...
	    stormsubmit.submitTopology("KafkaTopology", conf, builder.createTopology());
